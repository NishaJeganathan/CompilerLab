...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_declarations = 11,              /* declarations  */
  YYSYMBOL_declaration = 12,               /* declaration  */
  YYSYMBOL_type = 13,                      /* type  */
  YYSYMBOL_id_list = 14                    /* id_list  */
};
...
static const char *const yytname[] =
{
  ...
  "CHAR", "';'", "','", "$accept", "program", "declarations",
  "declaration", "type", "id_list", YY_NULLPTR
};
