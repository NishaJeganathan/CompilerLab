...
static const char *const yytname[] =
{
  ...
  "MUL", "ASSIGN", "SEMI", "$accept", "program", "stmt", "expr", "term",
  "factor", YY_NULLPTR
};
...
#line 54 "intermediate.y"
                          {
        char buffer[50];
        sprintf(buffer, "%s = %s", (yyvsp[-3].str), (yyvsp[-1].str));
        addIC(buffer);
     }
#line 1108 "intermediate.tab.c"
    break;

  case 5: /* expr: expr PLUS term  */
#line 61 "intermediate.y"
                     {
        char *t = newTemp();
        char buffer[50];
        sprintf(buffer, "%s = %s + %s", t, (yyvsp[-2].str), (yyvsp[0].str));
        addIC(buffer);
        (yyval.str) = t;
     }
#line 1120 "intermediate.tab.c"
    break;

  case 6: /* expr: term  */
#line 68 "intermediate.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1126 "intermediate.tab.c"
    break;

  case 7: /* term: term MUL factor  */
#line 71 "intermediate.y"
                      {
        char *t = newTemp();
        char buffer[50];
        sprintf(buffer, "%s = %s * %s", t, (yyvsp[-2].str), (yyvsp[0].str));
...
#line 1138 "intermediate.tab.c"
    break;

  case 8: /* term: factor  */
#line 78 "intermediate.y"
             { (yyval.str) = (yyvsp[0].str); }
#line 1144 "intermediate.tab.c"
    break;

  case 9: /* factor: ID  */
#line 81 "intermediate.y"
           { (yyval.str) = (yyvsp[0].str); }
#line 1150 "intermediate.tab.c"
    break;

  case 10: /* factor: NUM  */
#line 82 "intermediate.y"
            { (yyval.str) = (yyvsp[0].str); }
#line 1156 "intermediate.tab.c"
    break;


#line 1160 "intermediate.tab.c"
